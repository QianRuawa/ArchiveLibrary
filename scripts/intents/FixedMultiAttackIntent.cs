...
/// <summary>固定伤害多段攻击，不受力量加成。</summary>
public class FixedMultiAttackIntent : AttackIntent, ICustomIntentDescription
{
    ...
    public FixedMultiAttackIntent(int damage, int repeat)
    {
        _damage = damage;
        _repeat = repeat;
        _repeatCalc = null;
    ...
    public FixedMultiAttackIntent(int damage, Func<int> repeatCalc)
    {
        _damage = damage;
        _repeat = 0;
